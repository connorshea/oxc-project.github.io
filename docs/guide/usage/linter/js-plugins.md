...
Note that the above list is not exhaustive, and *many* other ESLint plugins will work with Oxlint as well. These are just some popular plugins that we have explicitly tested.
